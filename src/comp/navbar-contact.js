...
class NavbarContact extends Component {
    ...
    render() {
        ...
        return (
            <div className="navbarcontact" style={{ fontFamily: "'Nunito', cursive" }}>
                <div className="container-xxl position-relative p-0">
                    ...
                    <div class="container-xxl py-5 bg-dark hero-header mb-5">
                        <div class="container text-center my-5 pt-5 pb-4">
                            <h1 class="display-3 text-white mb-3 animated slideInDown">Связаться с Нами</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center text-uppercase">
                                    <li class="breadcrumb-item"><Link to="/" class="nav-item nav-link1" style={{ textDecoration: 'none' }}>Главная</Link></li>
                                    <li class="breadcrumb-item"><Link to="/about" class="nav-item nav-link1" style={{ textDecoration: 'none' }}>О нас</Link></li>
